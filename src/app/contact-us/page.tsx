...
const ContactForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)} className="my-20 space-y-5 max-w-5xl mx-auto ">
      ...
      <SelectContent>
        <SelectGroup>
          ...
          <SelectItem className="py-3 text-md" value="incident">Incident</SelectItem>
          <SelectItem className="py-3 text-md" value="request">Request</SelectItem>
          <SelectItem className="py-3 text-md" value="change">Change</SelectItem>
        </SelectGroup>
      </SelectContent>
    </Select>
